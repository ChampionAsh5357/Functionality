...
package net.ashwork.functionality.predicate.abstracts.primitive.shorts;
 ...
 */
@InheritOnly
public interface AbstractShortPredicate1<P extends AbstractShortPredicate1<P>> extends AbstractPredicateN<P>, InputChainableInput<Short>, FunctionVariant<Boolean, ShortToBooleanFunction1>, UnboxedInput<AbstractPredicate1<Short, ?>> {
     ...
     */
    @Override
    AbstractPredicate1<Short, ?> boxInput();
    ...
    @Override
    AbstractShortPredicate1<P> not();

    @Override
    AbstractShortPredicate1<P> and(final P other);

    @Override
    AbstractShortPredicate1<P> or(final P other);

    @Override
    default AbstractShortPredicate1<P> xor(final P other) {
        return (AbstractShortPredicate1<P>) AbstractPredicateN.super.xor(other);
    }

    @Override
    default AbstractShortPredicate1<P> sub(final P other) {
        return (AbstractShortPredicate1<P>) AbstractPredicateN.super.sub(other);
    }

    @Override
    default AbstractShortPredicate1<P> nand(final P other) {
        return (AbstractShortPredicate1<P>) AbstractPredicateN.super.nand(other);
    }

    @Override
    default AbstractShortPredicate1<P> nor(final P other) {
        return (AbstractShortPredicate1<P>) AbstractPredicateN.super.nor(other);
    }

    @Override
    default AbstractShortPredicate1<P> xnor(final P other) {
        return (AbstractShortPredicate1<P>) AbstractPredicateN.super.xnor(other);
    }

    @Override
    default AbstractShortPredicate1<P> orNot(final P other) {
        return (AbstractShortPredicate1<P>) AbstractPredicateN.super.orNot(other);
    }
}
