...
package net.ashwork.functionality.predicate.abstracts.primitive.ints;
 ...
 */
@InheritOnly
public interface AbstractIntPredicate1<P extends AbstractIntPredicate1<P>> extends AbstractPredicateN<P>, InputChainableInput<Integer>, Variant<IntPredicate>, FunctionVariant<Boolean, IntToBooleanFunction1>, UnboxedInput<AbstractPredicate1<Integer, ?>> {
     ...
     */
    @Override
    AbstractPredicate1<Integer, ?> boxInput();
    ...
    @Override
    AbstractIntPredicate1<P> not();

    @Override
    AbstractIntPredicate1<P> and(final P other);

    @Override
    AbstractIntPredicate1<P> or(final P other);

    @Override
    default AbstractIntPredicate1<P> xor(final P other) {
        return (AbstractIntPredicate1<P>) AbstractPredicateN.super.xor(other);
    }

    @Override
    default AbstractIntPredicate1<P> sub(final P other) {
        return (AbstractIntPredicate1<P>) AbstractPredicateN.super.sub(other);
    }

    @Override
    default AbstractIntPredicate1<P> nand(final P other) {
        return (AbstractIntPredicate1<P>) AbstractPredicateN.super.nand(other);
    }

    @Override
    default AbstractIntPredicate1<P> nor(final P other) {
        return (AbstractIntPredicate1<P>) AbstractPredicateN.super.nor(other);
    }

    @Override
    default AbstractIntPredicate1<P> xnor(final P other) {
        return (AbstractIntPredicate1<P>) AbstractPredicateN.super.xnor(other);
    }

    @Override
    default AbstractIntPredicate1<P> orNot(final P other) {
        return (AbstractIntPredicate1<P>) AbstractPredicateN.super.orNot(other);
    }
}
