...
package net.ashwork.functionality.predicate.abstracts.longs;
 ...
 */
@InheritOnly
public interface AbstractLongPredicate1<B extends AbstractPredicate1<Long, B>, P extends AbstractLongPredicate1<B, P>> extends AbstractPredicateN<P>, Variant<LongPredicate>, FunctionVariant<Boolean, LongToBooleanFunction1>, UnboxedInput<AbstractPredicate1<Long, B>> {
     ...
     */
    @Override
    default AbstractPredicate1<Long, B> boxInput() {
        return this::test;
    }
    ...
    @Override
    default AbstractLongPredicate1<B, P> not() {
        return (final long value) -> !this.test(value);
    }

    @Override
    default AbstractLongPredicate1<B, P> and(final P other) {
        return (final long value) -> this.test(value) && other.test(value);
    }

    @Override
    default AbstractLongPredicate1<B, P> or(final P other) {
        return (final long value) -> this.test(value) || other.test(value);
    }

    @Override
    default AbstractLongPredicate1<B, P> xor(final P other) {
        return (AbstractLongPredicate1<B, P>) AbstractPredicateN.super.xor(other);
    }

    @Override
    default AbstractLongPredicate1<B, P> sub(final P other) {
        return (AbstractLongPredicate1<B, P>) AbstractPredicateN.super.sub(other);
    }

    @Override
    default AbstractLongPredicate1<B, P> nand(final P other) {
        return (AbstractLongPredicate1<B, P>) AbstractPredicateN.super.nand(other);
    }

    @Override
    default AbstractLongPredicate1<B, P> nor(final P other) {
        return (AbstractLongPredicate1<B, P>) AbstractPredicateN.super.nor(other);
    }

    @Override
    default AbstractLongPredicate1<B, P> xnor(final P other) {
        return (AbstractLongPredicate1<B, P>) AbstractPredicateN.super.xnor(other);
    }

    @Override
    default AbstractLongPredicate1<B, P> orNot(final P other) {
        return (AbstractLongPredicate1<B, P>) AbstractPredicateN.super.orNot(other);
    }
}
