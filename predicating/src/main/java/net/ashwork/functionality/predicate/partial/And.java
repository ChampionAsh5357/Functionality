...
public interface And<T extends And<T>> {
     ...
     * This is the equivalent of calling {@code A & B} or a logical {@code AND}.
     *
     * @param other the intersected object
     * @return a combined object that represents the intersection of this object and the
     *         {@code other} object
     */
    And<T> and(final T other);
}
