...
package net.ashwork.functionality.predicate.abstracts.primitive.floats;
 ...
 */
@InheritOnly
public interface AbstractFloatPredicate1<P extends AbstractFloatPredicate1<P>> extends AbstractPredicateN<P>, InputChainableInput<Float>, FunctionVariant<Boolean, FloatToBooleanFunction1>, UnboxedInput<AbstractPredicate1<Float, ?>> {
     ...
     */
    @Override
    AbstractPredicate1<Float, ?> boxInput();
    ...
    @Override
    AbstractFloatPredicate1<P> not();

    @Override
    AbstractFloatPredicate1<P> and(final P other);

    @Override
    AbstractFloatPredicate1<P> or(final P other);

    @Override
    default AbstractFloatPredicate1<P> xor(final P other) {
        return (AbstractFloatPredicate1<P>) AbstractPredicateN.super.xor(other);
    }

    @Override
    default AbstractFloatPredicate1<P> sub(final P other) {
        return (AbstractFloatPredicate1<P>) AbstractPredicateN.super.sub(other);
    }

    @Override
    default AbstractFloatPredicate1<P> nand(final P other) {
        return (AbstractFloatPredicate1<P>) AbstractPredicateN.super.nand(other);
    }

    @Override
    default AbstractFloatPredicate1<P> nor(final P other) {
        return (AbstractFloatPredicate1<P>) AbstractPredicateN.super.nor(other);
    }

    @Override
    default AbstractFloatPredicate1<P> xnor(final P other) {
        return (AbstractFloatPredicate1<P>) AbstractPredicateN.super.xnor(other);
    }

    @Override
    default AbstractFloatPredicate1<P> orNot(final P other) {
        return (AbstractFloatPredicate1<P>) AbstractPredicateN.super.orNot(other);
    }
}
