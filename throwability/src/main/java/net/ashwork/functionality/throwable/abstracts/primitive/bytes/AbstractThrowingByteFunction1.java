 ...
 */
@InheritOnly
public interface AbstractThrowingByteFunction1<R, H extends AbstractThrowingByteFunction1.Handler<R>> extends AbstractThrowingFunctionN<R, H>, InputChainableInput<Byte>, UnboxedInput<ThrowingFunction1<Byte, R>> {
