 ...
 *
 * @param <A> the type of the function which unboxes the {@code int} input and {@code short} result
 ...
 */
@InheritOnly
public interface AbstractThrowingIntToShortFunction1<A extends AbstractThrowingFunction1<Integer, Short, ?>, I extends AbstractThrowingToShortFunction1<Integer, A, ?>, R extends AbstractThrowingIntFunction1<Short, A, ?>, H extends AbstractThrowingIntToShortFunction1.Handler> extends AbstractThrowingToShortFunctionN<H>, InputChainableInput<Integer>, UnboxedAll<A, I, R> {
