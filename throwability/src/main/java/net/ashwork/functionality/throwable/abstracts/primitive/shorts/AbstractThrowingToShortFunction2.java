 ...
 */
@InheritOnly
public interface AbstractThrowingToShortFunction2<T1, T2, H extends AbstractThrowingToShortFunction2.Handler<T1, T2>> extends AbstractThrowingToShortFunctionN<H>, UnboxedResult<AbstractThrowingFunction2<T1, T2, Short, ?>> {
     ...
     */
    @Override
    AbstractThrowingFunction2<T1, T2, Short, ?> boxResult();
    ...
    @SuppressWarnings("unchecked")
    @Override
    default <V> AbstractThrowingFunction2<T1, T2, V, ?> andThen(final Function1<? super Short, ? extends V> after) {
        return (AbstractThrowingFunction2<T1, T2, V, ?>) AbstractThrowingToShortFunctionN.super.andThen(after);
    }
     ...
     */
    @Override
    <V> AbstractThrowingFunction2<T1, T2, V, ?> andThenUnchecked(final Function1<? super Short, ? extends V> after);
