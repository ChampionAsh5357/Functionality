 ...
 *
 * @param <A> the type of the function which unboxes the {@code boolean} input and {@code char} result
 ...
 */
@InheritOnly
public interface AbstractThrowingBooleanToCharFunction1<A extends AbstractThrowingFunction1<Boolean, Character, ?>, I extends AbstractThrowingToCharFunction1<Boolean, A, ?>, R extends AbstractThrowingBooleanFunction1<Character, A, ?>, H extends AbstractThrowingBooleanToCharFunction1.Handler> extends AbstractThrowingToCharFunctionN<H>, InputChainableInput<Boolean>, UnboxedAll<A, I, R> {
