 ...
 *
 * @param <A> the type of the function which unboxes the {@code double} input and {@code char} result
 ...
 */
@InheritOnly
public interface AbstractThrowingDoubleToCharFunction1<A extends AbstractThrowingFunction1<Double, Character, ?>, I extends AbstractThrowingToCharFunction1<Double, A, ?>, R extends AbstractThrowingDoubleFunction1<Character, A, ?>, H extends AbstractThrowingDoubleToCharFunction1.Handler> extends AbstractThrowingToCharFunctionN<H>, InputChainableInput<Double>, UnboxedAll<A, I, R> {
