 ...
 *
 * @param <A> the type of the function which unboxes the {@code float} input and {@code boolean} result
 ...
 */
@InheritOnly
public interface AbstractThrowingFloatToBooleanFunction1<A extends AbstractThrowingFunction1<Float, Boolean, ?>, I extends AbstractThrowingToBooleanFunction1<Float, A, ?>, R extends AbstractThrowingFloatFunction1<Boolean, A, ?>, H extends AbstractThrowingFloatToBooleanFunction1.Handler> extends AbstractThrowingToBooleanFunctionN<H>, InputChainableInput<Float>, UnboxedAll<A, I, R> {
