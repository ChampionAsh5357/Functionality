 ...
 */
@InheritOnly
public interface AbstractThrowingToLongFunction2<T1, T2, H extends AbstractThrowingToLongFunction2.Handler<T1, T2>> extends AbstractThrowingToLongFunctionN<H>, UnboxedResult<ThrowingFunction2<T1, T2, Long>> {
