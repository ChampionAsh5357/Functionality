 ...
 *
 * @param <A> the type of the function which unboxes the {@code int} input and {@code byte} result
 ...
 */
@InheritOnly
public interface AbstractThrowingIntToByteFunction1<A extends AbstractThrowingFunction1<Integer, Byte, ?>, I extends AbstractThrowingToByteFunction1<Integer, A, ?>, R extends AbstractThrowingIntFunction1<Byte, A, ?>, H extends AbstractThrowingIntToByteFunction1.Handler> extends AbstractThrowingToByteFunctionN<H>, InputChainableInput<Integer>, UnboxedAll<A, I, R> {
