 ...
 */
@InheritOnly
public interface AbstractThrowingDoubleFunction1<R, H extends AbstractThrowingDoubleFunction1.Handler<R>> extends AbstractThrowingFunctionN<R, H>, InputChainableInput<Double>, UnboxedInput<ThrowingFunction1<Double, R>> {
