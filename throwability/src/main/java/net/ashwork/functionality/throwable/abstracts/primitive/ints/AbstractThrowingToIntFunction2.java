 ...
 * This is the throwing variation of {@link ToIntFunction2}.
 *
 * @apiNote
 ...
 */
@InheritOnly
public interface AbstractThrowingToIntFunction2<T1, T2, H extends AbstractThrowingToIntFunction2.Handler<T1, T2>> extends AbstractThrowingToIntFunctionN<H>, UnboxedResult<AbstractThrowingFunction2<T1, T2, Integer, ?>> {
     ...
     */
    @Override
    AbstractThrowingFunction2<T1, T2, Integer, ?> boxResult();
    ...
    @SuppressWarnings("unchecked")
    @Override
    default <V> AbstractThrowingFunction2<T1, T2, V, ?> andThen(final Function1<? super Integer, ? extends V> after) {
        return (AbstractThrowingFunction2<T1, T2, V, ?>) AbstractThrowingToIntFunctionN.super.andThen(after);
    }
     ...
     */
    @Override
    <V> AbstractThrowingFunction2<T1, T2, V, ?> andThenUnchecked(final Function1<? super Integer, ? extends V> after);
