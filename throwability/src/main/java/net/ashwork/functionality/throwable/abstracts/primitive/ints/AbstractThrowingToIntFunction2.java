 ...
 */
@InheritOnly
public interface AbstractThrowingToIntFunction2<T1, T2, U extends AbstractThrowingFunction2<T1, T2, Integer, ?>, H extends AbstractThrowingToIntFunction2.Handler<T1, T2>> extends AbstractThrowingToIntFunctionN<H>, UnboxedResult<U> {
