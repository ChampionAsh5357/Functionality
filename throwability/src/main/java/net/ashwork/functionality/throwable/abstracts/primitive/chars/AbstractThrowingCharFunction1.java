 ...
 */
@InheritOnly
public interface AbstractThrowingCharFunction1<R, H extends AbstractThrowingCharFunction1.Handler<R>> extends AbstractThrowingFunctionN<R, H>, InputChainableInput<Character>, UnboxedInput<ThrowingFunction1<Character, R>> {
