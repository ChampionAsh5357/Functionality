 ...
 */
@InheritOnly
public interface AbstractThrowingToFloatFunction2<T1, T2, H extends AbstractThrowingToFloatFunction2.Handler<T1, T2>> extends AbstractThrowingToFloatFunctionN<H>, UnboxedResult<ThrowingFunction2<T1, T2, Float>> {
