 ...
 */
@InheritOnly
public interface AbstractThrowingToByteFunction2<T1, T2, H extends AbstractThrowingToByteFunction2.Handler<T1, T2>> extends AbstractThrowingToByteFunctionN<H>, UnboxedResult<ThrowingFunction2<T1, T2, Byte>> {
