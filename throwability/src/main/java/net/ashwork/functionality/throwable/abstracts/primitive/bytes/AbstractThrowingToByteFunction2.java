 ...
 */
@InheritOnly
public interface AbstractThrowingToByteFunction2<T1, T2, U extends AbstractThrowingFunction2<T1, T2, Byte, ?>, H extends AbstractThrowingToByteFunction2.Handler<T1, T2>> extends AbstractThrowingToByteFunctionN<H>, UnboxedResult<U> {
