 ...
 */
@InheritOnly
public interface AbstractThrowingToFloatFunction1<T1, H extends AbstractThrowingToFloatFunction1.Handler<T1>> extends AbstractThrowingToFloatFunctionN<H>, InputChainableInput<T1>, UnboxedResult<ThrowingFunction1<T1, Float>> {
