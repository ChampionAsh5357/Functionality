 ...
 *
 * @param <A> the type of the function which unboxes the {@code boolean} input and {@code double} result
 ...
 */
@InheritOnly
public interface AbstractThrowingBooleanToDoubleFunction1<A extends AbstractThrowingFunction1<Boolean, Double, ?>, I extends AbstractThrowingToDoubleFunction1<Boolean, A, ?>, R extends AbstractThrowingBooleanFunction1<Double, A, ?>, H extends AbstractThrowingBooleanToDoubleFunction1.Handler> extends AbstractThrowingToDoubleFunctionN<H>, InputChainableInput<Boolean>, UnboxedAll<A, I, R> {
