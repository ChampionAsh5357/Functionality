 ...
 *
 * @param <A> the type of the function which unboxes the {@code long} input and {@code float} result
 ...
 */
@InheritOnly
public interface AbstractThrowingLongToFloatFunction1<A extends AbstractThrowingFunction1<Long, Float, ?>, I extends AbstractThrowingToFloatFunction1<Long, A, ?>, R extends AbstractThrowingLongFunction1<Float, A, ?>, H extends AbstractThrowingLongToFloatFunction1.Handler> extends AbstractThrowingToFloatFunctionN<H>, InputChainableInput<Long>, UnboxedAll<A, I, R> {
