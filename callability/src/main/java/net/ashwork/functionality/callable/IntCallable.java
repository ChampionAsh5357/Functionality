...
/**
 * Represents task that returns {@code int}-valued results and may
 * throw an exception. This is the {@code int}-producing primitive
 * specialization of {@link Callable}.
 *
 * <p>This is a functional interface whose functional method is {@link #callAsInt()}.
 *
 * @see Callable
 * @since 2.1.0
 */
...
public interface IntCallable {
     ...
     * @see IntSupplier
     */
    default IntSupplier handle(final ExceptionHandler onException) {
        return () -> {
            try {
     ...
     * callable was unable to compute a result by returning {@code 0}.
     *
     * @return A supplier which swallows any exception thrown by this
     *         callable by returning {@code 0}
     * @see IntSupplier
     */
    default IntSupplier swallow() {
        return this.handle(e -> 0);
    }
