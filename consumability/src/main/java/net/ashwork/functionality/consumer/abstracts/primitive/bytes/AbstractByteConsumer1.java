...
public interface AbstractByteConsumer1<C extends AbstractByteConsumer1<C>> extends AbstractConsumerN<C>, UnboxedInput<AbstractConsumer1<Byte, ?>> {
     ...
     */
    @Override
    AbstractConsumer1<Byte, ?> boxInput();

    @Override
    default AbstractByteConsumer1<C> andThen(final C after) {
        return (AbstractByteConsumer1<C>) AbstractConsumerN.super.andThen(after);
    }

    @Override
    AbstractByteConsumer1<C> andThenUnchecked(final C after);
