...
package net.ashwork.functionality.consumer.abstracts.primitive.shorts;
 ...
 */
@InheritOnly
public interface AbstractShortConsumer1<C extends AbstractShortConsumer1<C>> extends AbstractConsumerN<C>, UnboxedInput<AbstractConsumer1<Short, ?>> {
     ...
     */
    @Override
    AbstractConsumer1<Short, ?> boxInput();

    @Override
    default AbstractShortConsumer1<C> andThen(final C after) {
        return (AbstractShortConsumer1<C>) AbstractConsumerN.super.andThen(after);
    }

    @Override
    AbstractShortConsumer1<C> andThenUnchecked(final C after);
