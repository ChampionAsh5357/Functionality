...
package net.ashwork.functionality.consumer.abstracts.floats;
 ...
 */
@InheritOnly
public interface AbstractFloatConsumer1<B extends AbstractConsumer1<Float, B>, C extends AbstractFloatConsumer1<B, C>> extends AbstractConsumerN<C>, UnboxedInput<AbstractConsumer1<Float, B>> {
     ...
     */
    @Override
    default AbstractConsumer1<Float, B> boxInput() {
        return this::accept;
    }

    @Override
    default AbstractFloatConsumer1<B, C> andThen(final C after) {
        return (AbstractFloatConsumer1<B, C>) AbstractConsumerN.super.andThen(after);
    }

    @Override
    default AbstractFloatConsumer1<B, C> andThenUnchecked(final C after) {
