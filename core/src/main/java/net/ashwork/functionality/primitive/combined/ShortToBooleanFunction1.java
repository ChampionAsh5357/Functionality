...
/**
 * Represents a function that accepts a {@code short}-valued argument and produces a {@code boolean}-valued result.
 * This is the one-arity specialization of {@link ToBooleanFunctionN}.
 * This is the {@code short}-consuming primitive specialization of {@link ToBooleanFunction1}.
 * This is the {@code boolean}-producing primitive specialization of {@link ShortFunction1}.
 *
 ...
 */
@FunctionalInterface
public interface ShortToBooleanFunction1 extends ToBooleanFunctionN, InputChainableInput<Short>, UnboxedAll<Function1<Short, Boolean>, ToBooleanFunction1<Short>, ShortFunction1<Boolean>> {
     ...
     */
    boolean applyAsBoolean(final short value);
     ...
     */
    @Override
    default Function1<Short, Boolean> box() {
     ...
     */
    @Override
    default ToBooleanFunction1<Short> boxInput() {
        return this::applyAsBoolean;
    }
     ...
     */
    @Override
    default ShortFunction1<Boolean> boxResult() {
        return this::applyAsBoolean;
    }
    ...
    @Override
    default <V> ToBooleanFunction1<V> compose(final Function1<? super V, ? extends Short> before) {
     ...
     */
    @Override
    default <V> ToBooleanFunction1<V> composeUnchecked(final Function1<? super V, ? extends Short> before) {
    ...
    default <V> ShortFunction1<V> andThen(final Function1<? super Boolean, ? extends V> after) {
        return (ShortFunction1<V>) ToBooleanFunctionN.super.andThen(after);
    }
