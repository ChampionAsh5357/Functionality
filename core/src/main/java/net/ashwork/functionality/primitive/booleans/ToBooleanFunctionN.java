...
/**
 * Represents a function that accepts {@code n} arguments and produces a {@code boolean}-valued result.
 * This is the {@code boolean}-producing primitive specialization for {@link FunctionN}.
 ...
 */
@FunctionalInterface
public interface ToBooleanFunctionN extends FunctionN<Boolean> {
     ...
     */
    boolean applyAllAsBooleanUnchecked(final Object... args);

    @Override
    default Boolean applyAllUnchecked(final Object... args) {
     ...
     */
    class Instance implements ToBooleanFunctionN {

        private final int arity;
        private final ToBooleanFunction1<Object[]> function;
         ...
         */
        public Instance(final int arity, final ToBooleanFunction1<Object[]> function) {
            this.arity = arity;
        ...
        @Override
        public boolean applyAllAsBooleanUnchecked(final Object... args) {
        ...
        public <V> FunctionN.Instance<V> andThen(Function1<? super Boolean, ? extends V> after) {
            return (FunctionN.Instance<V>) ToBooleanFunctionN.super.andThen(after);
        }

        @Override
        public <V> FunctionN.Instance<V> andThenUnchecked(Function1<? super Boolean, ? extends V> after) {
            return new FunctionN.Instance<>(this.arity(), (final Object[] args) -> after.apply(this.function.applyAsBoolean(args)));
        }
    }
}
