 ...
 * This is the {@code long}-consuming primitive specialization of {@link ToBooleanFunction1}.
 * This is the {@code boolean}-producing primitive specialization of {@link LongFunction1}.
 *
 ...
 */
@FunctionalInterface
public interface LongToBooleanFunction1 extends ToBooleanFunctionN, InputChainableInput<Long>, UnboxedAll<Function1<Long, Boolean>, ToBooleanFunction1<Long>, LongFunction1<Boolean>> {
     ...
     */
    @Override
    default Function1<Long, Boolean> box() {
     ...
     */
    @Override
    default ToBooleanFunction1<Long> boxInput() {
        return this::applyAsBoolean;
    }
     ...
     */
    @Override
    default LongFunction1<Boolean> boxResult() {
        return this::applyAsBoolean;
    }
    ...
    @Override
    default <V> ToBooleanFunction1<V> compose(final Function1<? super V, ? extends Long> before) {
     ...
     */
    @Override
    default <V> ToBooleanFunction1<V> composeUnchecked(final Function1<? super V, ? extends Long> before) {
    ...
    default <V> LongFunction1<V> andThen(final Function1<? super Boolean, ? extends V> after) {
        return (LongFunction1<V>) ToBooleanFunctionN.super.andThen(after);
    }
